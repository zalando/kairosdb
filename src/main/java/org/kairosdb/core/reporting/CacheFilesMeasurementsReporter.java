...
public class CacheFilesMeasurementsReporter implements KairosMetricReporter {
    @Inject
    ...
    private final CacheFilesMetricsProvider metricsProvider;

    private String hostname;

    @Inject
    public CacheFilesMeasurementsReporter(final CacheFilesMetricsProvider metricsProvider, @Named(HOSTNAME) final String hostname) {

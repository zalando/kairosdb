...
public class InfluxDBModule extends AbstractModule {
    ...
    public InfluxDBModule(Properties props) {
    ...
    protected void configure() {
        bind(Datastore.class).to(InfluxDBDatastore.class).in(SINGLETON);
        bind(InfluxDBDatastore.class).in(SINGLETON);
        bind(InfluxDBConfiguration.class).in(SINGLETON);
    }
}
